...
# url of the package
URL_python_numba=https://github.com/numba/numba/archive/refs/tags/${VERSION_python_numba}.tar.gz

# md5 of the package
MD5_python_numba=48408821fa403ef10ab97ce69e4299c8
