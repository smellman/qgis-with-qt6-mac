...
VERSION_python_rasterio=1.4.3

# dependencies of this recipe
DEPS_python_rasterio=(python gdal python_gdal python_packages)

# url of the package
URL_python_rasterio=https://github.com/rasterio/rasterio/archive/refs/tags/${VERSION_python_rasterio}.tar.gz

# md5 of the package
MD5_python_rasterio=f0c794c7aa80e45956cc60b162d3af71
