...
VERSION_python_scikit_learn=1.6.1

# dependencies of this recipe
DEPS_python_scikit_learn=(
    python
    python_packages
    python_numpy
    python_scipy
...
# url of the package
URL_python_scikit_learn=https://github.com/scikit-learn/scikit-learn/archive/refs/tags/${VERSION_python_scikit_learn}.tar.gz

# md5 of the package
MD5_python_scikit_learn=315419f54437bbc0af23e979c9896025
