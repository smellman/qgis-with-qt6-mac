...
VERSION_apache_arrow=18.1.0
LINK_apache_arrow_version=1801.0.0
LINK_apache_arrow=libarrow.${LINK_apache_arrow_version}.dylib
...
# url of the package
URL_apache_arrow=https://downloads.apache.org/arrow/arrow-${VERSION_apache_arrow}/apache-arrow-${VERSION_apache_arrow}.tar.gz

# md5 of the package
MD5_apache_arrow=5578bc40a3d8e6588a5f0bde96f26819
