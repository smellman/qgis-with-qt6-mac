...
DESC_python_netcdf4="Python binding of NetCDF4"

# version of your package
# need to keep in sync with compatible version of netcdf lib
VERSION_python_netcdf4=1.7.1.post1
...
# url of the package
URL_python_netcdf4=https://github.com/Unidata/netcdf4-python/archive/refs/tags/v${VERSION_python_netcdf4}.tar.gz

# md5 of the package
MD5_python_netcdf4=37c718744e7d690e9e28910724135a8b
