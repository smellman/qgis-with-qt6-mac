...
VERSION_grass_minor=4
VERSION_grass=${VERSION_grass_major}.${VERSION_grass_minor}.0
...
# url of the package
URL_grass=https://github.com/OSGeo/grass/releases/download/${VERSION_grass}/grass-${VERSION_grass}.tar.gz

# md5 of the package
MD5_grass=9362028835f2cb5a36a5a067bea2dde1
