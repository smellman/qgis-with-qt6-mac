...
VERSION_abseil_cpp=20240722.0
LINK_abseil_cpp_version=2407.0.0
...
# url of the package
URL_abseil_cpp=https://github.com/abseil/abseil-cpp/releases/download/${VERSION_abseil_cpp}/abseil-cpp-${VERSION_abseil_cpp}.tar.gz

# md5 of the package
MD5_abseil_cpp=740fb8f35ebdf82740c294bde408b9c0
