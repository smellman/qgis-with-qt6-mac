...
# url of the package
URL_libzip=https://github.com/nih-at/libzip/releases/download/v${VERSION_libzip}/libzip-${VERSION_libzip}.tar.gz

# md5 of the package
MD5_libzip=a28c00eaba4c62c02f1c40df3834d453
