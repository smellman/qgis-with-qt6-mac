...
VERSION_c_ares=1.34.4
LINK_c_ares_version=2.19.3
...
# url of the package
URL_c_ares=https://github.com/c-ares/c-ares/releases/download/v${VERSION_c_ares}/c-ares-${VERSION_c_ares}.tar.gz

# md5 of the package
MD5_c_ares=136230025fc9c9d510cb29fdc998a6ea
