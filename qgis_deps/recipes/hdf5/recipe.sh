...
VERSION_hdf5=${VERSION_hdf5_major}.5
...
# url of the package
URL_hdf5=https://support.hdfgroup.org/releases/hdf5/v1_14/v1_14_5/downloads/hdf5-${VERSION_hdf5}.tar.gz

# md5 of the package
MD5_hdf5=600d29af6ccb7f1e3401560e1422ba5e
