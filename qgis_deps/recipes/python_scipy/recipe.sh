...
# url of the package
URL_python_scipy=https://github.com/scipy/scipy/releases/download/v${VERSION_python_scipy}/scipy-${VERSION_python_scipy}.tar.gz

# md5 of the package
MD5_python_scipy=161e1937805a55cc940bd09f4f1a759a
...
function build_python_scipy() {
    ...
    # or
    DYLD_LIBRARY_PATH=$STAGE_PATH/lib try $PIP install scipy==${VERSION_python_scipy}
