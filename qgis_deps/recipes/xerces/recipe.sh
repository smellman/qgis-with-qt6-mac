...
VERSION_xerces=3.3.0

LINK_libxerces_c=libxerces-c-3.3.dylib
# dependencies of this recipe
DEPS_xerces=(expat libcurl libicu)

# url of the package
URL_xerces=https://downloads.apache.org/xerces/c/3/sources/xerces-c-${VERSION_xerces}.tar.gz
URL_xerces=https://archive.apache.org/dist/xerces/c/3/sources/xerces-c-${VERSION_xerces}.tar.gz

# md5 of the package
MD5_xerces=1b7778f47d5eab1644f59c87ed06ac19
...
function build_xerces() {
    ...
    try install_name_tool -id $STAGE_PATH/lib/$LINK_libxerces_c $STAGE_PATH/lib/$LINK_libxerces_c
