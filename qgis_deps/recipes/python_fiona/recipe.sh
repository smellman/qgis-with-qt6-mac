...
DESC_python_fiona="Fiona reads and writes geographic data files"

# version of your package
# keep in SYNC with gdal receipt
VERSION_python_fiona=1.10.1

# dependencies of this recipe
DEPS_python_fiona=(python python_packages gdal python_gdal)

# url of the package
URL_python_fiona=https://github.com/Toblerity/Fiona/archive/refs/tags/${VERSION_python_fiona}.tar.gz

# md5 of the package
MD5_python_fiona=18b5db57708af803ba6cec8343e2d970
