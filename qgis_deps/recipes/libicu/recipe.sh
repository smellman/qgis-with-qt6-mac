...
# url of the package
URL_libicu=https://github.com/unicode-org/icu/archive/refs/tags/release-$VERSION_libicu_major-$VERSION_libicu_minor.tar.gz

# md5 of the package
MD5_libicu=74475dd9525cac1561513b19f9fc66bb
