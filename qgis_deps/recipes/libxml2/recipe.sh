...
# url of the package
# TODO fix the URL
URL_libxml2=https://download.gnome.org/sources/libxml2/2.13/libxml2-${VERSION_libxml2}.tar.xz

# md5 of the package
MD5_libxml2=0b919be8edff97ade9c946e1a83bdecd
