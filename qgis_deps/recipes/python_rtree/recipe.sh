...
VERSION_python_rtree=1.3.0

# dependencies of this recipe
DEPS_python_rtree=(python python_packages spatialindex)

# url of the package
URL_python_rtree=https://github.com/Toblerity/rtree/archive/refs/tags/${VERSION_python_rtree}.tar.gz

# md5 of the package
MD5_python_rtree=f8cbe574b941f38e6dc0f56aa0c99ad3
...
function build_python_rtree() {
    ...
    # TODO: check this patch is still needed
