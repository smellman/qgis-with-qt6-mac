...
VERSION_thrift=0.21.0
LINK_thrift_version=${VERSION_thrift}
...
# url of the package
URL_thrift=https://downloads.apache.org/thrift/${VERSION_thrift}/thrift-${VERSION_thrift}.tar.gz

# md5 of the package
MD5_thrift=de687816fcde2b91a4dab31b8b02b1cf
