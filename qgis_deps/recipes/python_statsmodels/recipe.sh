...
VERSION_python_statsmodels=0.14.4

# dependencies of this recipe
DEPS_python_statsmodels=(
    python
    python_packages
    python_numpy
    python_scipy
...
# url of the package
URL_python_statsmodels=https://github.com/statsmodels/statsmodels/archive/refs/tags/v${VERSION_python_statsmodels}.tar.gz

# md5 of the package
MD5_python_statsmodels=7c92617d0e6bd227d724fee8c81687b0
