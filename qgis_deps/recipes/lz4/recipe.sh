...
# url of the package
URL_lz4=https://github.com/lz4/lz4/releases/download/v${VERSION_lz4}/lz4-${VERSION_lz4}.tar.gz

# md5 of the package
MD5_lz4=dead9f5f1966d9ae56e1e32761e4e675
