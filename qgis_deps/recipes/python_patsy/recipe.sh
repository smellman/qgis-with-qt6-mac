...
DESC_python_patsy="Describing statistical models in Python using symbolic formulas"

# version of your package
VERSION_python_patsy=1.0.1

# dependencies of this recipe
DEPS_python_patsy=(python python_packages python_numpy)

# url of the package
URL_python_patsy=https://github.com/pydata/patsy/archive/refs/tags/v${VERSION_python_patsy}.tar.gz

# md5 of the package
MD5_python_patsy=2181ddeacd2a895fc0dfe53fe4e5b7bf
