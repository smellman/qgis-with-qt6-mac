...
VERSION_python_geopandas=1.0.1
...
DEPS_python_geopandas=(
  ...
  python_pandas
  python_psycopg2
  # python_matplotlib # install matplotlib from pip
)

# url of the package
URL_python_geopandas=https://github.com/geopandas/geopandas/releases/download/v${VERSION_python_geopandas}/geopandas-${VERSION_python_geopandas}.tar.gz

# md5 of the package
MD5_python_geopandas=71bb538fef2d4ac88368400316a22275
