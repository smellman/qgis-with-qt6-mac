...
VERSION_qwt_major=6
VERSION_qwt=$VERSION_qwt_major.3.0
...
# md5 of the package
MD5_qwt=06a8f8eb1bc07bedfb1df601804439cb
...
function build_qwt() {
    ...
    try install_name_tool -id "@rpath/qwt.framework/qwt" ${STAGE_PATH}/lib/qwt.framework/qwt
