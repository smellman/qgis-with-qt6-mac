...
VERSION_protobuf=29.3
LINK_protobuf_lite=libprotobuf-lite.${VERSION_protobuf}.0.dylib
LINK_protobuf=libprotobuf.${VERSION_protobuf}.0.dylib
...
# md5 of the package
MD5_protobuf=4bc7da60038e4b10de416415c7988ec7
